...
public struct SGRect: CustomStringConvertible {

    public var origin: SGPoint

    public var center: SGPoint

    public var size: SGSize

    public var cornerPoints: [SGPoint]

    public var max: SGPoint

    public var min: SGPoint
    ...
    public init(origin: SGPoint, size: SGSize) {
        self.origin = origin
        self.size = size
    ...
    public static var zero: SGRect { return .init() }

    public static func center(origin: SGPoint, size: SGSize) -> SGPoint {
    ...
    public static func cornerPoints(origin: SGPoint, size: SGSize) -> [SGPoint] {
...
extension SGRect: AdditiveArithmetic {
    public static func - (lhs: SGRect, rhs: SGRect) -> SGRect {
...
extension SGRect: Comparable {
    ...
    public static func < (lhs: SGRect, rhs: SGRect) -> Bool {
...
extension SGRect: SGScalable {
    ...
    public func scaled(by: SGSize) -> SGRect {
    ...
    public func scaledBy(x: Double, y: Double, z: Double) -> SGRect {
        let scaledSize: SGSize = SGSize(width: self.size.width * x, height: self.size.height * y, depth: self.size.depth * z)
        return SGRect(origin: self.origin, size: scaledSize)
    }
    ...
    public func uniformlyScaled(by magnitude: Double) -> SGRect {
